...
Button::Button(std::string _button_name, int x, int y) { 
    ...
    button_textbox = new Textbox(BLACK_COLOR, button_name, x, y, 40, back_to_1982_font);
    hovering_textbox = new Textbox(GREEN_COLOR, button_name, x, y, 40, back_to_1982_font);
